...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[           
            InlineKeyboardButton('📢 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 📢', url=f'https://t.me/Eliteflix_Official')
            ],[
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton("📢 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 📢", url="https://t.me/Eliteflix_Official")
            ],[      
        ...
        m=await message.reply_sticker("CAACAgUAAxkBAAEIkqRkOMjiqQWKtugXAWG1onMwjdUvaQAC0wYAAuXVsFTCTPPFFgfD9C8E")
